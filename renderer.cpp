...
void RenderApp::Initialize(int w, int h) {
    ...
    glfwSetKeyCallback((GLFWwindow*)window.GetWindowHandle(), 
        ...
        if (key == GLFW_KEY_A && action == GLFW_PRESS) { global_angle_z += 5.0; global_change = true; }
        if (key == GLFW_KEY_D && action == GLFW_PRESS) { global_angle_z -= 5.0; global_change = true; }
        if (key == GLFW_KEY_Q && action == GLFW_PRESS) { global_angle_y += 5.0; global_change = true; }
        if (key == GLFW_KEY_E && action == GLFW_PRESS) { global_angle_y -= 5.0; global_change = true; }
        if (key == GLFW_KEY_W && action == GLFW_PRESS) { global_angle_x += 5.0; global_change = true; }
        if (key == GLFW_KEY_S && action == GLFW_PRESS) { global_angle_x -= 5.0; global_change = true; }
    });
